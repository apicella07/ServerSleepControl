...
public interface PatientManagerInterface {
    ...
    //Y UN HISTORY DE EEGS Y HISTORY DE REPORTS: Sería una tabla que incluya una columna con fechas y al lado el nombre del report o del EEG --> Si queremos un nombre tendríamos que añadir a todas las funciones y en las clases REPORT e EEG un atributo nombre para así darlo!!
    // ESq lo de la tabla es como lo hacía adri --> YO SUPONGO QUE SEA DEVOLVER UN ARRAY DE LAS FECHAS EN UN MÉTODO Y OTRO DE LOS NOMBRES EN OTRO Y LUEGO UN  MÉTODO QUE CREE UNA TABLA CON AMBOS!
    //viewEEGHistory(dni)
